_base_ = [
    ...
    '../_base_/datasets/cityscapes_nsct.py', '../_base_/default_runtime.py',
    '../_base_/schedules/schedule_80k.py'
]

uper_swin_checkpoint_file = 'pretrain/converted_upernet_swin_large_patch4_window12_512x1024_pretrain_384x384_22K_80k_cityscapes.pth'
