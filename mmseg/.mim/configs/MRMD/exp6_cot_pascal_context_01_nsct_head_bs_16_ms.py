...
model = dict(
    ...
    backbone=dict(
        vit_backbone=dict(hfpe=False, img_size=480, pos_embed_interp=True, drop_rate=0.,
...
data = dict(samples_per_gpu=4,
            train=dict(nsct_dir='nsct_01'),
            val=dict(pipeline=test_pipeline, nsct_dir='nsct_01'),
            test=dict(pipeline=test_pipeline, nsct_dir='nsct_01'),
            )
