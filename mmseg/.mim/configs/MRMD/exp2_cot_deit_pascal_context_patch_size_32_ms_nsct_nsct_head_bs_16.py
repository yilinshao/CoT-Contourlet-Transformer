...
model = dict(
    ...
    backbone=dict(
        ms_nsct=True,
        vit_backbone=dict(img_size=480, pos_embed_interp=True, drop_rate=0., patch_size=32,
                          model_name='deit_base_distilled_path16_384', mla_channels=256, mla_index=(5, 11, 17, 23))),
